  ...
  return (
    <div className='flex flex-col gap-12 px-16 py-16 bg-white'>
      ...
      <div className='flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6'>
        <div>
        <h2 className='text-2xl font-bold text-gray-800'>Emerald Bistro</h2>  
      ...
      <p className='text-center text-sm text-gray-500 mt-4'>@ 2024 Emerald Bistro.All rights reserved.</p>
    </div>
  )
}
